...
function block() {
  return (
        ...
        <div className={"industry"}>Industry <span  className={"ipr"} >IPR: 100/ 200</span></div>
      <div className={"building"}>
        ...
        <div className={"hidden building-menu-position bottombarmenu"} >
          <form>
            <label>Build in bottom bar</label>
            <br/>
              <select className={'BottomBarBuild'} onChange={ClickEvents.getValue_bottombar} >
                <option value={"slot_for_building"}>Slot for build</option>
                <option value={'Administrarum'}>Administratum</option>
                <option value={'Manufactorum'}>Manufactorum</option>
                <option value={'Supply_depo'}>Supply depo</option>
              </select>
          </form>
